...
function image_reconstruction(post, chain, skym, output_dir, snapshot_ID; im_draws=false, fov=200.0, pix=128)
    ...
    if im_draws
	  ...
	  println("Image saved: $output_dir")
       end
    end
...
function main(args)
    ...
    mpi_run = joinpath((@__DIR__), "results/all/2025-08-07-11-37-02-Q4524rMb")
    ...
    # TODO
    output_dir = output_dir * "/update_figs"
    mkpath(output_dir)
