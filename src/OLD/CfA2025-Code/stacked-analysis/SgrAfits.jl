...
function main(args)
    ...
    data_path = joinpath((@__DIR__), "snapshot-modeling/scan027_pigeons/scan027-posterior_chain.jld2")
    mpi_run = joinpath((@__DIR__), "results/all/2025-07-28-18-45-50-IlG9aMDh")
    ...
    if isempty(args)
        snapshot_filepath = joinpath(@__DIR__, "data_comrade",
            "hops_3599_SGRA_LO_netcal_LMTcal_normalized_10s_preprocessed_snapshot_120_noisefrac0.02_scan27.jls")
    else
    ...
    # TODO
    output_dir = output_dir * "/pt-plots"
