...
files = filter(endswith(".uvfits"), readdir("hops_3599_MAD_a-0.5_Rh40_i50_LO/snapshot_120/noisefrac0.02/hops_3599_MAD_a-0.5_Rh40_i50_LO/", join=true))


mkpath("data_grmhdtest3599")

outs = joinpath.("data_grmhdtest3599", replace.(basename.(files), ".uvfits" => ".jls"))
